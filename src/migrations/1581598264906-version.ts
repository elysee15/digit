...
export class version1581598264906 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `prospection` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(191) NULL, `code_prospection` varchar(30) NULL, `status` enum ('En attente', 'En cours') NULL DEFAULT 'En cours', `type` enum ('Prospect', 'Client') NULL DEFAULT 'Prospect', `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `prospectId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `famille_de_mission` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(100) NULL, `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `besoin` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(191) NULL, `description` text NULL, `tag` varchar(191) NULL, `status` enum ('En cours', 'En attente') NULL DEFAULT 'En cours', `conclusion` text NULL, `priorite` enum ('Forte', 'Moyenne', 'Faible') NULL DEFAULT 'Forte', `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `prospectionId` int NULL, `familleDeMissionId` int NULL, `projetDeMissionId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `offre_de_mission` (`id` int NOT NULL AUTO_INCREMENT, `contexte` text NULL, `methodologie` text NULL, `etat` enum ('A envoyer', 'A ne pas envoyer') NULL DEFAULT 'A envoyer', `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `annexeId` int NULL, `projetDeMissionId` int NULL, `planingId` int NULL, `budgetId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `piece_jointe_mission` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(191) NULL, `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `projetId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `piece_jointe_question` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(191) NULL, `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `questionId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `questionnaire` (`id` int NOT NULL AUTO_INCREMENT, `libelle` varchar(191) NULL, `conclusion` text NULL, `created_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `created_by` varchar(100) NULL, `updated_by` varchar(100) NULL, `prospectionId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("ALTER TABLE `besoin` ADD CONSTRAINT `FK_6c51a293a6b1919ce5490b0c2f8` FOREIGN KEY (`familleDeMissionId`) REFERENCES `famille_de_mission`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        ...
        await queryRunner.query("ALTER TABLE `piece_jointe_mission` ADD CONSTRAINT `FK_3493db59d13dddfe8acb75dbca9` FOREIGN KEY (`projetId`) REFERENCES `projet_de_mission`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `piece_jointe_question` ADD CONSTRAINT `FK_97d40a973fd64a28e676e400afa` FOREIGN KEY (`questionId`) REFERENCES `question`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `piece_jointe_question` DROP FOREIGN KEY `FK_97d40a973fd64a28e676e400afa`", undefined);
        await queryRunner.query("ALTER TABLE `piece_jointe_mission` DROP FOREIGN KEY `FK_3493db59d13dddfe8acb75dbca9`", undefined);
