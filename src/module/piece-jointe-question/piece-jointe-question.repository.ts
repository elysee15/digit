...
export class PieceJointeQuestionRepository extends Repository<PieceJointeQuestionEntity>{
    constructor(
        @InjectRepository(PieceJointeQuestionEntity)
        private readonly pieceJointeQuestionRepository: Repository<PieceJointeQuestionEntity>
    ){
        super();
    }
