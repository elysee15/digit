...
export class QuestionnaireRepository extends Repository<QuestionnaireEntity>{
    ...
    async updated(questionnaireId: number, questionnaireDto: QuestionnaireEntity){
        return await this.questionnaireRepository.update(questionnaireId, questionnaireDto);
    }
