...
export class ProjetDeMissionRepository extends Repository<
  ProjetDeMissionEntity
> {
  constructor(
    @InjectRepository(ProjetDeMissionEntity)
    private readonly projetDeMissionRepository: Repository<
      ProjetDeMissionEntity
    >
  ) {
    super();
  ...
  async countProjet() {
    return await this.projetDeMissionRepository
      .createQueryBuilder("ProjetDeMissionEntity")
